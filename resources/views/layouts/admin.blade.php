...
<body class="font-sans antialiased relative">
  ...
  <div class="fs-5 fw-bold px-4 py-3 border-bottom border-blue-300">
    ...
    <nav class="mt-3">
        ...
        <a href="{{ route('admin.applicants.accepted') }}"class="{{ request()->routeIs('admin.applicants.accepted') ? 'active' : '' }}">Trúng tuyển</a>
        <a href="{{ route('admin.hr.index') }}"class="{{ request()->routeIs('admin.hr.index') ? 'active' : '' }}">Phòng Hành chính nhân sự</a>
        ...
        <a href="{{ route('admin.applicants.approved') }}" class="{{ request()->routeIs('admin.applicants.approved') ? 'active' : '' }}">Trạng thái phỏng vấn</a>
        <a href="#">Thư mời</a>
        <a href="#">Xác nhận phỏng vấn</a>
        <a href="#">Lịch phỏng vấn</a>
        <a href="#">Kết quả phỏng vấn</a>
        </div>
