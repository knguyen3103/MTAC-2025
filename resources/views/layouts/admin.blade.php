        ...
        <aside class="sidebar shadow">
            ...
            <nav class="mt-3">
                <a href="{{ route('dashboard') }}" class="group-title d-block {{ request()->routeIs('dashboard') ? 'active' : '' }}">
                    <i class="bi bi-house-door-fill me-2"></i> Trang chủ</a>
                ...
                <div id="menu-personal" class="submenu">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="{{ request()->routeIs('admin.users.index') ? 'active' : '' }}">Quản lý tài khoản</a>
                </div>
